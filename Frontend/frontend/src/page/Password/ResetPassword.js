...
function ResetPassword() {
  ...
  const handleSendOTP = async () => {
    ...
    setLoading(true);
    try {
      const res = await axios.post("https://e-learningg-47u8.onrender.com/auth/forgot-password", { Email: email });
  ...
  const handleVerifyOTP = async () => {
    ...
    try {
      const res = await axios.post("https://e-learningg-47u8.onrender.com/auth/verify-otp", { Email: email, otp });
      setSuccess(res.data.message);
  ...
  const handleResetPassword = async () => {
    ...
    try {
      const res = await axios.post("https://e-learningg-47u8.onrender.com/auth/reset-password-otp", { Email: email, newPassword });
      setSuccess(res.data.message);
