...
function CreateClass() {
  ...
  const fetchSubjects = async (majorId) => {
    ...
    try {
      ...
      const response = await axios.get(`https://e-learningg-47u8.onrender.com/subject/get-subjects-by-major/${majorId}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const fetchStudentsBySubject = async (majorId, subjectId) => {
    ...
    try {
      const response = await axios.get(`https://e-learningg-47u8.onrender.com/user/users-by-subject?majorId=${majorId}&subjectId=${subjectId}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const fetchTeachers = async (majorId) => {
    try {
      ...
      const response = await axios.get(`https://e-learningg-47u8.onrender.com/user/users-by-major/${majorId}?Role=${userRole}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const handleSubmit = async () => {
    try {
      ...
      await axios.post("https://e-learningg-47u8.onrender.com/class/create-class", simplifiedClassData, {
        headers: { Authorization: `Bearer ${token}` }
      });
