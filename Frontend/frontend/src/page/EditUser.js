...
const EditUser = () => {
  ...
  const fetchUserInfo = async () => {
    ...
    try {
        ...
        const res = await axios.get(`https://e-learningg-47u8.onrender.com/user/detail-user/${id}`, {
...
useEffect(() => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.put(`https://e-learningg-47u8.onrender.com/user/update-user/${id}`, formData, {
        headers: { Authorization: `Bearer ${token}`,
       },
