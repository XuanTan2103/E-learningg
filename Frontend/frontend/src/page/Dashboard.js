...
const Dashboard = () => {
  ...
  const fetAll = useCallback(async () => {
    try {
      ...
      const resClasses = await axios.get(`https://e-learningg-47u8.onrender.com/class/classes`, {
        headers: { Authorization: `Bearer ${token}` }
      });
      const resMajors = await axios.get(`https://e-learningg-47u8.onrender.com/major/majors`, {
        headers: { Authorization: `Bearer ${token}` }
      });
      const resSubject = await axios.get(`https://e-learningg-47u8.onrender.com/subject/subjects`, {
        headers: { Authorization: `Bearer ${token}` }
      });
      const resBlogs = await axios.get(`https://e-learningg-47u8.onrender.com/blog/blogs`, {
        headers: { Authorization: `Bearer ${token}` }
      });
      const resUsers = await axios.get(`https://e-learningg-47u8.onrender.com/user/users`, {
        headers: { Authorization: `Bearer ${token}` }
      });
  ...
  const updateChartStudentsByMajor = useCallback(async () => {
    axios
      .get("https://e-learningg-47u8.onrender.com/dashboard/students-by-major", {
        headers: { Authorization: `Bearer ${token}` }
      })
      .then((response) => {
  ...
  const updateChartClassesBySubject = useCallback(async () => {
    axios
      .get("https://e-learningg-47u8.onrender.com/dashboard/classes-by-subject", {
        headers: { Authorization: `Bearer ${token}` }
      })
      .then((response) => {
        const data = response.data;
  ...
  const updateChartSubjectsByMajor = useCallback(async () => {
    axios
      .get("https://e-learningg-47u8.onrender.com/dashboard/subjects-by-major", {
        headers: { Authorization: `Bearer ${token}` }
      })
      .then((response) => {
        const data = response.data;
  ...
  const updateChartTeachersByMajor = useCallback(async () => {
    axios
      .get("https://e-learningg-47u8.onrender.com/dashboard/teachers-by-major", {
        headers: { Authorization: `Bearer ${token}` }
      })
      .then((response) => {
        const data = response.data;
  ...
  const updateChartBlogByDay = useCallback(async () => {
    axios
      .get("https://e-learningg-47u8.onrender.com/dashboard/blog-by-day", {
        headers: { Authorization: `Bearer ${token}` }
      })
      .then((response) => {
  ...
  const updateChartMessagesByDay = useCallback(async () => {
    axios
      .get("https://e-learningg-47u8.onrender.com/dashboard/messages-by-day", {
        headers: { Authorization: `Bearer ${token}` }
      })
      .then((response) => {
        const data = response.data; // [{ date: "YYYY-MM-DD", count: number }, ...]
  ...
  const updateChartStudentStatus = useCallback(async () => {
    axios
      .get("https://e-learningg-47u8.onrender.com/dashboard/students-class-status", {
        headers: { Authorization: `Bearer ${token}` }
      })
      .then((response) => {
