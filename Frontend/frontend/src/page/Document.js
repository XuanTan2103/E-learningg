...
function Document({ classId: externalClassId }) {
    ...
    const fetchDocuments = async (classId) => {
        try {
            const response = await axios.get(`https://e-learningg-47u8.onrender.com/document/documents/class/${classId}`, {
                headers: { Authorization: `Bearer ${token}` }
            });
    ...
    const uploadDocument = async (e) => {
        ...
        try {
            await axios.post("https://e-learningg-47u8.onrender.com/document/upload-document", formData, {
    ...
    const updateDocument = async (e) => {
        ...
        try {
            ...
            await axios.put(`https://e-learningg-47u8.onrender.com/document/update-document/${editingDocument._id}`, documentData, {
                headers: { Authorization: `Bearer ${token}` }
            });
    ...
    const handleDelete = async (documentId) => {
        ...
        try {
            await axios.delete(`https://e-learningg-47u8.onrender.com/document/delete-document/${documentId}`, {
                headers: { Authorization: `Bearer ${token}` }
            });
    ...
    const handleDownload = async (documentId) => {
        ...
        try {
            const response = await axios.get(`https://e-learningg-47u8.onrender.com/document/download-document/${documentId}`, {
                headers: { Authorization: `Bearer ${token}` },
